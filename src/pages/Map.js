...
export default function Map({activities}) {
  var customMarker = new L.icon({
    iconUrl: require('../services/location_marker.png'),
    iconRetinaUrl: require('../services/location_marker.png'),
    iconSize: [35, 35],
    popupAnchor: [-2, -2],
  });
  ...
  return (
    <>
      <MapContainer center={[51.724938, 10.6948924]} zoom={6} scrollWheelZoom={true}>
        <Header />
        <TileLayer
